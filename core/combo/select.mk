...
ifeq ($(USE_LINARO_COMPILER_FLAGS),yes)
    $(combo_target)RELEASE_CFLAGS := -O3 -g -Wstrict-aliasing=3 -Werror=strict-aliasing $(call cc-option,-fno-aggressive-loop-optimizations)
else
    $(combo_target)RELEASE_CFLAGS := -O2 -fgcse-after-reload -fipa-cp-clone -fpredictive-commoning -fsched-spec-load -funswitch-loops -fvect-cost-model -g -Wstrict-aliasing=3 -Werror=strict-aliasing $(call cc-option,-fno-aggressive-loop-optimizations)
endif
